...
class Road extends React.Component {
    ...
    moveToLine3Point2M3() {
        ...
        console.log("this.props.point.x: " + this.props.point.x + " moveDistance:" + moveDistance + " MQ1XSpace:" + this.verticalRoadCoordinates.line3Point2.MQ1XSpace + " movePointX:" + movePointX);
